<!--pages/detail/detail.wxml - 完整版 -->
<view class="page-wrapper {{pageClass}}">
  <!-- 顶部 -->
  <view class="header">
    <view class="back-btn glass btn-press" bindtap="goBack">
  ...
  <view class="section" wx:if="{{recommendJokes.length > 0}}">
    <view class="section-header">
      ...
      <text class="section-count">4条推荐</text>
    </view>
    
    <!-- 两行两列布局 -->
    <view class="recommend-grid">
      <view class="recommend-item glass btn-press" 
      ...
      >
        ...
        <text class="recommend-meta">{{item.category}}</text>
      </view>
    </view>
  </view>
</view>